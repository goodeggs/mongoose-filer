...
(function() {
  ...
  Attachments.virtual('attachedFile').get(function() {
    return this._attachedFile != null ? this._attachedFile : this._attachedFile = new AttachedFile(this.id, {
  ...
  Attachments.pre('save', function(next) {
    ...
    return this.attachedFile.save(function(err) {
      if (err == null) {
        _this.file = null;
      }
      return next(err);
  ...
  exports = module.exports = function(schema, options) {
    ...
    if (!schema.path('attachments')) {
      ...
      schema.pre('remove', function(next) {
        var removes;
        removes = this.attachments.map(function(attachment) {
          return function(cb) {
