...
(function() {
  ...
  Attachments.virtual('config').get(function() {
    return this.__parent.schema.attachmentsConfig[this.name];
  });

  Attachments.virtual('attachedFile').get(function() {
    var _ref;
    return (_ref = this._attachedFile) != null ? _ref : this._attachedFile = new AttachedFile(this.__parent.id, {
      modelName: this.config.modelName || this.__parent.constructor.modelName,
  ...
  Attachments.pre('remove', function(next) {
    ...
    removeFn = function(cb) {
      ...
      return _this.__parent.removePre('save', removeFn);
    };
    this.__parent.pre('save', removeFn);
    return next();
  });
