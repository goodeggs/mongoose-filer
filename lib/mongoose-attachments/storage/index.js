...
(function() {
  ...
  exports = module.exports = Storage = (function() {
    ...
    Storage.prototype.path = function(style) {
      return path.join('/', this.attachment.prefix, this.attachment.id, style, "" + this.attachment.name + this.attachment.extension);
    };
  ...
  exports.configure = function(config) {
    ...
    return require("./" + adapter)(Storage, config[adapter]);
  };
